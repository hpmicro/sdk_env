...
- 将程序下载至开发板运行，电脑可自动识别并安装驱动，设备管理器可查看得到2个通用串行总线设备。
    ...
    .. image:: ../../../../../../../samples/cherryusb/device/winusb/winusb20/doc/PC_device_manager.png
       :alt: PC_device_manager.png

- 通过LLCOM调试工具，在《小工具-WinUSB》菜单中，下拉可以看到2个usb interface。

    .. image:: ../../../../../../../samples/cherryusb/device/winusb/winusb20/doc/LLCOM_config.png
       :alt: LLCOM_config.png

- 选择HPMicro WinUSB0或HPMicro WinUSB1，点击《打开》按钮，然后输入发送数据，在左边窗口将显示发送和接收的数据。

    .. image:: ../../../../../../../samples/cherryusb/device/winusb/winusb20/doc/LLCOM_communication.png
