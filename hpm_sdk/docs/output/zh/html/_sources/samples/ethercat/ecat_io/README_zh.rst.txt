...
~~~~~~~~~~
  ...
  .. image:: ../../../../../samples/ethercat/ecat_io/doc/ssc_version.png
     :alt:
...
~~~~~~~~~~~~~~~~~~~
  ...
  1. 进入 `ETG下载网页 <https://www.ethercat.org/en/downloads.html>`_ , 输入"SSC"过滤下载内容
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_download_1.png
       :alt:

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_download_2.png
       :alt:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  1. 打开SSC Tool, 选择 **Tool->Options**
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Tool_Options.png
       :alt:

  2. 选择Configurations, 选择添加配置文件<hpm_sdk>/samples/ethercat/ecat_io/SSC/Config/HPM_ECAT_IO_Config.xml

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Import_Configuration.png
       :alt:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  1. 点击 **File->New**
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_File_New.png
       :alt:

  2. 点击 **Custom** 选项, 并在下拉列表中选择 **HPMicro ECAT Digital IO <HPMicro>**

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_New_Project_Custom.png
       :alt:

  3. 保存工程文件, 指定保存路径

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Project_Save.png
       :alt:
  ...
  4. 导入应用
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Application_Import_1.png
       :alt:

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Application_Import_2.png
       :alt:

    - 点击 **OK**

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Application_Import_3.png
       :alt:
...
~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  1. 点击 **Project->Create new Slave Files**
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Create_Slave_1.png
       :alt:

  2. 选择输出路径, 须设置Src输出路径为ecat_io/SSC/Src路径, 或者设置其他路径将生成的生成的Src复制到ecat_io/SSC/Src目录下
  3. 点击Start生成从站代码和ESI文件

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/SSC_Create_Slave_2.png
       :alt:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  .. image:: ../../../../../samples/ethercat/ecat_io/doc/ssc_pdi_int.png
     :alt:

  通过打patch的方式修改SSC代码，在SSC目录下的命令行窗口执行：patch -d Src < ssc_pdi_mask.patch

  .. image:: ../../../../../samples/ethercat/ecat_io/doc/ssc_patch.png
     :alt:
...
~~~~~~~~~~~~~~~~~~~~
  ...
  .. image:: ../../../../../samples/ethercat/ecat_io/doc/esc_device_physics.png
     :alt:
...
~~~~~~~~~~~~~~~~
  ...
  1. 打开TwinCAT软件，选择 **File->New->Project**
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_new_project_1.png
       :alt:

  2. 选择 **TwinCAT Project** , 命名后点击 **OK**

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_new_project_2.png
       :alt:
...
~~~~~~~~~~~~~~~~
  ...
  1. 更新网卡驱动(第一次使用时需要)
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_ethernet_driver.png
       :alt:

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_ethernet_driver_2.png
       :alt:
  ...
  2. 时钟设置
    ...
    软件运行时可能遇到如下报错：Init4\RTime：Start Interrupt：Ticker started >> AdsWarning4115 （0x1013,RTIME：system clock setup failed）, 需要以管理员权限运行C：\TwinCAT\3.1\System\win8settick.bat
      ...
      .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_set_tick.png
         :alt:
...
~~~~~~~~~~~~~~~~
  ...
  1. 点击Device, 右键Scan
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_scan.png
       :alt:

  2. 选择对应的网络设备

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_scan_2.png
       :alt:
...
~~~~~~~~~~~~~~~~
  ...
  1. 双击扫描出的设备, 选择 **Online** , 选择 **Box** , 右键选择 **EEPROM Update** 。
      ...
      * **在EEPROM内容为空的情况下, ESC上电加载EEPROM数据时会出现checksum错误, 该错误会造成PDI不工作, 此时EtherCAT通信是可能的, 可以通过主站更新EEPROM内容。** *
      ...
      .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_eeprom_update_io.png
         :alt:

  2. 选择对应的ESI文件, 点击 **OK** , 等待更新完成

      .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_eeprom_update_3.png
         :alt:

  3. 重新上电评估板, 删除已扫描出的设备重新扫描后, 运行设备

      .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_device_remove.png
         :alt:

      .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_scan_device_2.png
         :alt:
...
~~~~~~~~~~~~
  ...
  1. 输入IO, 拨动评估板上的拨码SW6, InputCounter数值发生变化
    ...
    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_input.png
       :alt:

  2. 输出IO, 双击OutputCounter, 选择Online, 点击Write写入数值。 评估板LED9和LED3发生变化

    .. image:: ../../../../../samples/ethercat/ecat_io/doc/Twincat_output.png
       :alt:
...
~~~~~~~~~~~~
  ...
  1. 设置从站的同步模式，此处可以为从站设置单独的Shift Time(Shift Time用于保证所有的从站都能在DC同步事件到来前收到主站发来的数据)
      ...
      .. image:: ../../../../../samples/ethercat/ecat_io/doc/twincat_slave_set_dc.png
         :alt:
  ...
  2. 设置主站的同步模式，通过主站的Sync Shift Time可以设置所有DC同步模式从站的shift time(通常为Sync Unit Cycle时间的20%~30%)， 单个从站的实际Shift Time = 主站设置的Shift Time + 从站设置的Shift Time
      ...
      .. image:: ../../../../../samples/ethercat/ecat_io/doc/twincat_master_set_dc.png
         :alt:
  ...
  3. 点击Restart TwinCAT（Config Mode)，从站可以在DC同步模式下进入OP状态，实际使用中应该在TwinCAT中创建任务(如PLC task或NC Task)，设置从站与主站任务进行同步，激活配置后进入Run Mode，保证同步性能，实现在DC同步模式下工作
      ...
      .. image:: ../../../../../samples/ethercat/ecat_io/doc/twincat_restart_config_mode.png
         :alt:
